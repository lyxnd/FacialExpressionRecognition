...
def load_model():
    ...
    """
    model = CNN3()
    model.load_weights('./models/fer2013/cnn3_best.weights.h5')
    # model.load_weights('./models/ck+/cnn3_best.weights.h5')
    # model.load_weights('./models/jafee/cnn3_best.weights.h5')
    return model
